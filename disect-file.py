...
file_name = r'C:\Maru\bhavferi-data\Middlesex18.txt'
#file_name = r'C:\Maru\bhavferi-data\sample-for-test.txt'
...
def get_township(df, municipality_code, municipality_name_state):
    ...
    township_df = _df[['property_location', 'owner_name','street_address','city_state','zip_code']]
    ...
    return township_df[['last_name', 'first_name','street_nbr','street_nm','property_city_state', 'possible_rental']]
...
#print(df.head())
tdf = get_township(df, '1217', 'PISCATAWAY, NJ')
print(tdf.shape)# 248263
print(tdf.head(25))
tdf.to_csv(r'C:\Maru\bhavferi-data\pisc.csv', sep=',', na_rep='', header=True, index=False)
